...
output_dir <- "/common/lix5lab/Li_Xue_Cut_Tag_06162022/Analysis_WYZ/mm39/edgeR_DE_results/CTK27ac"
...
metadata <- metadata[metadata$histone_marker == "CTK27ac", , drop = FALSE]
...
process_edgeR_comp <- function(row_data) {
  ...
  # Quantification file
  # =========================================================
  file_path <- file.path(quant_dir, paste0(cps_id, "_macs3_per_sample_summit_profile_bins.xls"))
